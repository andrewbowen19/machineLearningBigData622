...
tree_fit <- tree_spec %>%
 fit(winner ~ elo1_pre + elo2_pre + elo_prob1 + elo_prob2 + elo1_post + elo2_post + qbelo1_pre + qbelo2_pre + qb1_value_pre + qb2_value_pre + qb1_adj + qb2_adj + qbelo_prob1 + qbelo_prob2, data = train)
